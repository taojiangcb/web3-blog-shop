...
export default function Aurora(props: AuroraProps) {
  ...
  const propsRef: MutableRefObject<AuroraProps> = useRef(props);
  ...
  useEffect(() => {
    ...
    let program: Program & { uniforms: ProgramUniforms };
    ...
    const update = (t: number) => {
      ...
      program.uniforms.uColorStops.value = stops.map((hex: string): number[] => {
        const c = new Color(hex);
        return [c.r, c.g, c.b];
      });
